...
const Status = ({ isLoading, onItemChange = () => {} }) => {
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
                                            ...
                                            onClick={() => handleItemClick('tous')}
                                            color="#868E96"
                                            selected={selectedItem === 'tous'}
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
                                            ...
                                            onClick={() => handleItemClick('CREE')}
                                            color="#0AE650"
                                            selected={selectedItem === 'CREE'}
                                        />
                                    </Grid>
                                    ...
                                    <Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
                                            ...
                                            onClick={() => handleItemClick('en cours')}
                                            selected={selectedItem === 'en cours'}
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
                                            ...
                                            onClick={() => handleItemClick('cloture')}
                                            selected={selectedItem === 'cloture'}
                                        />
                                    </Grid>
                                    <Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
                                            ...
                                            onClick={() => handleItemClick('annuler')}
                                            selected={selectedItem === 'annuler'}
                                        />
                                    </Grid>
                                    {/*<Grid item xs={12} sm={2} lg={2}>
                                        <ShadowBox
